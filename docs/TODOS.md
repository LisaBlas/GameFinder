...
- [ ] Ship or hide "User Crafted" and "Best crafts": either wire real community/low-result data behind these cards now, or relabel/remove until the backing data exists — currently promising a feature that isn't there.
...
- [ ] Instrument outbound click tracking (UTM params + GA event) on all five affiliate partner links, not just Kinguin, to get revenue-per-partner visibility.
